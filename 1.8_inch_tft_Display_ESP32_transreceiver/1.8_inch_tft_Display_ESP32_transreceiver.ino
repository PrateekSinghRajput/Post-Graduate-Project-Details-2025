...
// ESP-NOW data structure (updated to include NPK values)
...
void OnDataRecv(const esp_now_recv_info_t *esp_now_info, const uint8_t *incomingData, int len) {
  ...
  noInterrupts();
  if (tempData.nodeId == 172) {  // Update with your node IDs
...
void drawAllDataScreen() {
  ...
  // Node 1 data (top section)
  tft.setTextColor(GREEN);
  tft.setCursor(10, 20);
  tft.print("Node ");
  tft.print(localNode1Data.nodeId);
  tft.print(": ");
  ...
  if (localNode1Received) {
    ...
    // NPK values (compact display)
    tft.setCursor(10, 55);
    tft.print("NPK: ");
    tft.setTextColor(YELLOW);
    tft.print(localNode1Data.nitrogen);
    tft.print("-");
    tft.print(localNode1Data.phosphorous);
    tft.print("-");
    tft.print(localNode1Data.potassium);
  ...
  // Divider line
  tft.drawFastHLine(0, 70, tft.width(), WHITE);
  
  // Node 2 data (bottom section)
  tft.setTextColor(BLUE);
  tft.setCursor(10, 80);
  tft.print("Node ");
  tft.print(localNode2Data.nodeId);
  tft.print(": ");
  ...
  if (localNode2Received) {
    ...
    tft.print("NPK: ");
    tft.setTextColor(YELLOW);
    tft.print(localNode2Data.nitrogen);
    tft.print("-");
    tft.print(localNode2Data.phosphorous);
    tft.print("-");
    tft.print(localNode2Data.potassium);
